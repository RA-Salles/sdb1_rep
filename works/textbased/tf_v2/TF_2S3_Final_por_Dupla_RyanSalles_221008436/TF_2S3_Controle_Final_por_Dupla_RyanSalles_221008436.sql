...
-- Autor(es) ..............: Paulo Filho, Paulo Sousa, Victor Guimaraes, Ryan Salles
...
-- ---------------------------------------------------------
CREATE DATABASE IF NOT EXISTS TF_2I; -- garante que o script vai rodar caso o script físico nunca tenha sido rodado
...
CREATE USER IF NOT EXISTS 'ultrauser'
	IDENTIFIED BY '1D3L33TSTUFF'
    DEFAULT ROLE MESTRE
    PASSWORD EXPIRE INTERVAL 30 DAY;
...
CREATE USER IF NOT EXISTS 'michael.jackson'
	IDENTIFIED BY 'heeeheee'
    DEFAULT ROLE ADM
    PASSWORD EXPIRE INTERVAL 90 DAY;
...
CREATE USER IF NOT EXISTS 'pequeno.silva'
	IDENTIFIED BY 'oPequenoSilva'
    DEFAULT ROLE COMERCIAL
    PASSWORD EXPIRE INTERVAL 180 DAY;
...
CREATE USER IF NOT EXISTS 'big.johnson'
	IDENTIFIED BY 'largejohnsonmuitograndeenorme'
    DEFAULT ROLE CONTADOR
    PASSWORD EXPIRE INTERVAL 180 DAY;
